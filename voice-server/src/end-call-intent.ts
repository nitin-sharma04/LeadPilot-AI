 ...
 * (Mirrored in src/lib/voice/end-call-intent.ts)
 */
...
/** Lead is explicitly complaining the call is still open — hang up ASAP after a brief ack. */
...
/** Agent natural closing — no trailing question. */
...
/**
 * Agent finished with a natural goodbye (application-level end signal).
 * Rejects turns that still ask a question.
 */
